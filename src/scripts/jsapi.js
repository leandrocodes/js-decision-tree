	...
	;(function () {
		...
		var A = function (a, b) {
			b
				...
				: ba.test(a) &&
				  ...
				  -1 != a.indexOf("'") && (a = a.replace(v, '&#39;')),
				  -1 != a.indexOf('\x00') && (a = a.replace(w, '&#0;')))
			return a
		}
		function B(a) {
		...
		google.load = function (a, b, c) {
			function d(g) {
				...
				'undefined' != typeof k[1] &&
					((e = k[0]), (c.packages = c.packages || []), c.packages.push(k[1]))
			}
			var e = a
			c = c || {}
			if (
			...
			if ((a = J[':' + e])) {
				...
				c &&
					...
					((f = c.callback),
					f.match(/^[[\]A-Za-z0-9._]+$/) && ((f = window.eval(f)), (c.callback = f)))
				if ((f = c && null != c.callback) && !a.F(b))
					throw G("Module: '" + e + "' must be loaded before DOM onLoad!")
				f
					? a.v(b, c)
		...
		google.ha = function (a, b) {
			b
				? (0 == L.length &&
						(M(window, 'load', N),
						(!B('msie') && !B('safari') && !B('konqueror') && B('mozilla')) ||
						window.opera
							...
							: (B('safari') || B('konqueror')) && window.setTimeout(O, 10)),
				  L.push(a))
				: M(window, 'load', a)
		}
		...
		google.loader.aa = function () {
			...
			'complete' == a.readyState &&
				((a.onreadystatechange = null), a.parentNode.removeChild(a), N())
		}
		...
		google.loader.g = function (a, b, c) {
			...
			if (c) {
				...
				'script' == a
					? ((e = '<script src="' + A(b) + '" type="text/javascript"'),
					  d && (e += ' nonce="' + A(d) + '"'),
					  document.write(e + '>\x3c/script>'))
					: 'css' == a &&
					  ((e = '<link href="' + A(b) + '" type="text/css" rel="stylesheet"'),
					  d && (e += ' nonce="' + A(d) + '"'),
		...
		google.loader.fa = function (a) {
			if ((a = a.specs) && a.length)
				for (var b = 0; b < a.length; ++b) {
					...
					'string' == typeof c
						? (J[':' + c] = new Q(c))
						: ((c = new R(c.name, c.baseSpec, c.customSpecs)), (J[':' + c.name] = c))
				}
		}
		...
		Q.prototype.load = function (a, b) {
			...
			if (c.length) {
				...
				for (g = 0; g < f.length; g++)
					(k = f[g]), (this.h[':' + k] = []), d && this.h[':' + k].push(e)
				if (
					b ||
					null == K[':' + this.b] ||
					null == K[':' + this.b].versions[':' + a] ||
					google.loader.AdditionalParams ||
					!this.u
				)
					(b && b.autoloaded) || google.loader.g('script', this.j(a, b), d)
				else {
					a = K[':' + this.b]
					...
					for (var D in a.properties)
						D &&
							':' == D.charAt(0) &&
							(google[this.b][D.substring(1)] = a.properties[D])
				...
				this.u &&
					...
					1 != this.f % 100 && (this.f = -1))
				for (g = 0; g < f.length; g++) (k = f[g]), (this.m[':' + k] = !0)
			}
		}
		Q.prototype.s = function (a) {
			;-1 != this.f &&
				(T('al_' + this.b, 'jl.' + (new Date().getTime() - this.f), !0), (this.f = -1))
		...
		S.prototype.Z = function (a) {
			this.w[':' + a] &&
				((this.w[':' + a] = !1), this.D--, 0 == this.D && window.setTimeout(this.Y, 0))
		}
		function R(a, b, c) {
			this.name = a
			this.X = b
		...
		R.prototype.load = function (a, b) {
			...
			c
				? (this.o.push(b.callback), (b.callback = 'google.loader.callbacks.' + this.name))
				: (this.l = !0)
		...
		P.prototype.j = function (a, b) {
			if (!this.i.versions[':' + a]) {
				...
				if (!this.i.versions[':' + a])
					throw G("Module: '" + this.b + "' with version '" + a + "' not found!")
			}
			return (
		...
		var V = !1,
			...
			T = function (a, b, c) {
				c
					? fa([a], [b])
					: (Y(),
					  W.push('r' + W.length + '=' + encodeURIComponent(a + (b ? '|' + b : ''))),
					  window.setTimeout(X, 5 < W.length ? 0 : 15e3))
			},
			X = function () {
				if (W.length) {
...
google.load('visualization', '1', { autoloaded: true, packages: ['orgchart'] })
if (window['google'] != undefined && window['google']['loader'] != undefined) {
	if (!window['google']['visualization']) {
		window['google']['visualization'] = {}
		google.visualization.Version = '1.0'
		google.visualization.JSHash = '36558b280aac4fa99ed8215e60015cff'
		google.visualization.LoadArgs = 'file\x3dvisualization\x26v\x3d1\x26packages\x3dorgchart'
	}
	google.loader.writeLoadTag(
		'css',
		google.loader.ServiceBase +
			'/api/visualization/1.0/36558b280aac4fa99ed8215e60015cff/ui+pt_BR.css',
		false
	)
	google.loader.writeLoadTag(
		'script',
		google.loader.ServiceBase +
			'/api/visualization/1.0/36558b280aac4fa99ed8215e60015cff/format+pt_BR,default+pt_BR,ui+pt_BR,orgchart+pt_BR.I.js',
		false
	)
}
